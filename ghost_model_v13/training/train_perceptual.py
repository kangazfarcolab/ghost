...
"""
Ghost v12 - Optimized Swarm Trainer (Vectorized)
================================================
...
class SwarmTrainerOptimized:
    def __init__(self, cfg):
        ...
        print(f"Initializing Ghost v12 (Vectorized)...")
        self.model = GhostWorkerV13(
            dim=cfg.dim, 
    ...
    def run(self):
        ...
        self.model.save_weights(os.path.join(self.cfg.checkpoint_dir, "ghost_v12_perceptual_final.safetensors"))
