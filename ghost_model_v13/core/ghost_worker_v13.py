...
from ghost_model_v13.core.ternary_linear import TernaryLinear
from ghost_model_v13.core.learned_codebook import CodebookLinear, LearnedCodebook
from ghost_model_v13.core.ternary_mamba import TernaryMamba, TernaryMambaConfig
from ghost_model_v13.core.mixture_of_depths import MoDRouter
from ghost_model_v13.core.cognitive_memory import CognitiveMemory
...
class GhostWorkerV13(nn.Module):
    """
    ...
    @property
    def memory(self):
        if id(self) not in GhostWorkerV13._memory_banks:
            GhostWorkerV13._memory_banks[id(self)] = CognitiveMemory(self.dim, max_entries=self.memory_size)
        return GhostWorkerV13._memory_banks[id(self)]
    
    @property
    def _stats(self):
        if id(self) not in GhostWorkerV13._stats_store:
            GhostWorkerV13._stats_store[id(self)] = {
                'depth_skipped': 0, 'surprise_skipped': 0, 'mod_skipped': 0, 'total': 0
            }
        return GhostWorkerV13._stats_store[id(self)]
