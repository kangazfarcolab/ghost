...
from ghost_model_v12.training.muon import Muon
...
def train_awakening():
    ...
    # 1. Model
    model = GhostWorkerV12(dim=cfg.dim, num_layers=cfg.num_layers)
    ...
    if loss.item() < 0.5:
        ...
        os.makedirs("ghost_model_v12/checkpoints", exist_ok=True)
        model.save_weights("ghost_model_v12/checkpoints/ghost_v12_awakened.safetensors")
