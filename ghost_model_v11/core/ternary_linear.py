...
class TernaryLinear(nn.Module):
    ...
    def __call__(self, x):
        ...
        positive = (self.weight > t).astype(mx.float32)
        negative = (self.weight < -t).astype(mx.float32)
        ...
        # Straight-Through Estimator: use ternary forward, full backward
        w_ste = mx.stop_gradient(w_scaled - self.weight) + self.weight
